...
export default function LeadForm() {
  ...
  return (
    <section id="lead-form" style={{ padding: '96px 0', background: 'linear-gradient(180deg, #F8FAFC, #FFFFFF)' }}>
      <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 24px' }}>
        <div style={{ maxWidth: '640px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '40px' }}>
            <p style={{ fontSize: '14px', fontWeight: 700, color: '#0EA5E9', textTransform: 'uppercase', letterSpacing: '2px', marginBottom: '12px' }}>Get Started</p>
            <h2 style={{ fontSize: '36px', fontWeight: 800, color: '#1E293B', marginBottom: '16px' }}>Ready to Invest?</h2>
            <p style={{ fontSize: '18px', color: '#64748B' }}>Fill the form below and our team will get in touch within 24 hours.</p>
          </div>

          <div style={{ background: '#FFFFFF', borderRadius: '24px', boxShadow: '0 4px 24px rgba(14,165,233,0.08)', border: '1px solid #E2E8F0', padding: '40px' }}>
            {success ? (
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div style={{ marginBottom: '24px' }}>
                  <label style={{ display: 'block', fontSize: '14px', fontWeight: 600, marginBottom: '8px' }}>Proposed Investment Amount (₹)</label>
                  <div style={{ position: 'relative' }}>
